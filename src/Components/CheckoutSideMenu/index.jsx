...
function CheckoutSideMenu() {
    ...
    return (
        ...
        <aside // Dependiendo del valor de isCheckoutSideMenuOpen, se muestra/oculta CheckoutSideMenu.
            className={`${context.isCheckoutSideMenuOpen ? 'flex' : 'hidden'} flex flex-col fixed right-0 top-[60px] w-[360px] bg-white dark:bg-zinc-800 dark:text-white border border-inherit rounded-lg h-[calc(100vh-60px)]`}>
