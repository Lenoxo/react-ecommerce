...
function Navbar() {
  ...
  return (
    <nav className="flex justify-between items-center fixed z-1 w-full py-4 px-8 text-sm font-light top-0 border-b-2 bg-white dark:text-white dark:bg-zinc-900">
